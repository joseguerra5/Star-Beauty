import mockup from "../assets/rimel.png"
  ...
  return (
    <section className={styles.section}>
      ...
      <div className={styles.text}>
        ...
        <h2 className={styles.heading}>O estúdio perfeito para cuidar da sua Beleza</h2>
      ...
      <img src={mockup} alt="" className={styles.image}/>
      </div>
    </section>
  )
}